...
Setup note: I had to patch sovereign_agent/agents/research_agent.py to make tool calling work. 
The default Llama-3.3-70B was leaking fake function-call JSON into the message content instead of using OpenAI structured tool_calls, 
so I switched the model to Qwen/Qwen3-32B and updated the parser to read m.tool_calls. 

Both fixes came from the discussion in upstream issue:
https://github.com/sovereignagents/sovereign-agent-lab/issues/2."""   # optional — anything unexpected
...
TASK_B_IMAGE_URL_OR_ERROR = "https://pictures-storage.storage.eu-north1.nebius.cloud/text2img-1485eb73-fdd0-49be-bda2-2b86300fd9ed_00001_.webp"
